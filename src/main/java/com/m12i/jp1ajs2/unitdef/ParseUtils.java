...
public final class ParseUtils {
	...
	public static ParseResult parse(InputStream stream) {
		try {
			return ParseResult.success(new UnitParser().parse(stream));
		} catch (Exception e) {
	...
	public static ParseResult parse(InputStream stream,
			String charset) {
		try {
			return ParseResult.success(new UnitParser().parse(stream, charset));
		} catch (Exception e) {
			return ParseResult.failure(e);
		}
	}
	...
	public static ParseResult parse(String string) {
		try {
			return ParseResult.success(new UnitParser().parse(string));
		} catch (Exception e) {
			return ParseResult.failure(e);
		}
	}
