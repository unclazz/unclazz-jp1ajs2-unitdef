...
public final class TestUtils {
	...
	public static final String nestedUnitDefString1 = "unit=XXXX0000,0000,BBBBB,CCCCC;\r\n"
			+ "{\r\n"
			+ "	ty=g;\r\n"
			+ "	el=XXXX0001,g,+80 +48;\r\n" 
			...
			+ "	un=foobar;\r\n"
			+ "	fd=360;\r\n"
			+ "	unit=XXXX0001,0001,BBBBB,CCCCC;\r\n"
			+ "	{\r\n"
			+ "		ty=g;\r\n" 
			+ "		cm=\"これはコメントです。\";\r\n" 
			+ "	}\r\n"
			+ "	unit=XXXX0002,0002,BBBBB,CCCCC;\r\n"
			+ "	{\r\n"
			+ "		ty=g;\r\n" 
			+ "		cm=\"これはコメントです。\";\r\n" 
			+ "	}\r\n"
	...
	public static final String jobnetUnitDefString1 = "unit=XXXX0000,0000,BBBBB,CCCCC;\r\n"
			+ "{\r\n"
			+ "	ty=n;\r\n"
			+ "	el=XXXX0001,g,+80 +48;\r\n" 
			+ "	el=XXXX0002,g,+240 +144;\r\n"
	...
	public static final String jobnetUnitDefString2 = "unit=XXXX0000,0000,BBBBB,CCCCC;\r\n"
			+ "{\r\n"
			+ "	ty=n;\r\n"
			+ "	el=XXXX0001,g,+80 +48;\r\n" 
			+ "	el=XXXX0002,g,+240 +144;\r\n"
	...
	public static Parameter paramMockWithReturnValue(final String name, final String returnValue) {
		...
		return unitDef.query(Queries.parameters().nameEquals(name).one());
	}
}
